...
\definecolor{gray}{RGB}{83,83,83}                 % Custom color: dark blue
...
\begin{document}
	...
	\begin{list1}
		...
		Reject and Resubmit, \textit{\textbf{Quarterly Journal of Economics}}
		...
		Revise and Resubmit, \textit{\textbf{AEJ: Macro}}
		...
		\item[] \href{https://danicaratelli.github.io/research/papers/Cybersecurity_GE.pdf}{\textbf{``The Economic Costs of Cyber Risk''}}\\ with Aniket Baksy\smallskip
	...
	\begin{list1}
		\item[] Research Economist, Office of Financial Research, Dept. of the Treasury \hfill 2023 -- 2025 \smallskip
		...
		\item[] {Federal Reserve Bank of New York}, Summer Research Analyst \hfill 2014 \smallskip
	\end{list1}
	...
	\begin{list1}
		\item[] \emph{American Economic Journal: Macroeconomics}, \emph{Economic Journal}, \emph{International Journal of Forecasting}, \emph{Journal of Business \& Economic Statistics}, \emph{Journal of Official Statistics}, \emph{Journal of Political Economy: Macroeconomics}, \emph{National Science Foundation} (Grant Reviewer) \smallskip
	\end{list1}
	...
	\begin{list1}
		...
		\begin{itemize}\setlength{\itemindent}{.3cm}
			\item[2026:]\makebox[0.1cm]{\hfill} SIPA-FRBNY Workshop on Cyber Risk to Financial Stability\smallskip
