...
\begin{document}
	...
	\begin{list1}
		...
		\begin{itemize}\setlength{\itemindent}{.3cm}
			...
			\hspace*{0.55cm}Midwest Macro (Fall), CEPR MEF, Cattolica del Sacro Cuore
		\end{itemize}		
	\end{list1}
	...
	\begin{list1}
		\item[]
		\begin{itemize}\setlength{\itemindent}{.3cm}
			\item[2025:]\makebox[0.1cm]{\hfill} ASSA Meetings (discussion), WALES Conference (George Mason)
		\end{itemize}		
	\end{list1}
